...
public class CSCallLua : MonoBehaviour {
    ...
    [CSharpCallLua]//lua函数适配到 delegate， luatable到ineterface。
    ...
    void Start()
    {
        ...
        LuaTable d4 = luaenv.Global.Get<LuaTable>("d");//映射到LuaTable，by ref， 比interface要慢一个数量级
        ...
        LuaFunction d_e = luaenv.Global.Get<LuaFunction>("e"); //映射到luaFunction 
        d_e.Call();
